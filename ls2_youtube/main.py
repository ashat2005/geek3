...
async def share_user(meessage: types.Message):
    await meessage.answer(f"{meessage.from_user.full_name} вы можете поделиться своими данными",reply_markup=share_button)
